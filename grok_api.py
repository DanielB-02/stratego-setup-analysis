...
def transcribe_setup(path):
    ...
    Example:
    {
      "row_1": "['6', '6', '2', '2', '2', '7', '2', '2', '6', '6']"
      "row_2": "['4', '2', '9', '2', '5', '2', '10', '4', '3', '8']"
      "row_3": "['5', '4', 'B', 'B', '8', '1', '7', 'B', 'B', '5']"
      "row_4": "['7', '4', '3', '3', '3', '5', 'B', 'F', 'B', '3']"
    }
    """
    ...
    messages = [
        ...
        },
        {
            ...
            "content": """
    {
      "row_1": "['4', 'B', '4', '10', '4', '6', '2', '8', '5', '3']"
      "row_2": "['6', '2', '7', '2', '7', '2', '2', '1', '9', '6']"
      "row_3": "['8', '2', '5', 'B', '3', 'B', '4', '7', '2', '2']"
      "row_4": "['3', '3', 'B', 'F', 'B', 'B', '5', '5', '3', '6']"
    }
            """
        },
        {
        ...
        },
        {
            ...
            "content": """
    {
      "row_1": "['2', '6', '4', '2', '2', '5', '7', '2', '6', '2']"
      "row_2": "['8', '2', '4', 'B', '2', '9', '1', '3', '10', '7']"
      "row_3": "['5', '2', '7', 'B', '3', '8', 'B', '6', '4', 'B']"
      "row_4": "['3', '5', '3', '4', '6', '3', 'B', '5', 'B', 'F']"
    }
            """
        },
        {
